...
I want an architecture review anchored to the real code, the active milestone, the target architecture, and recent git history.
...
- compare at least two plausible directions internally, then present only the concise rationale
...
5. One question I should answer before changing anything
```
